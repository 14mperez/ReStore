...
export default function AboutPage() {
    ...
    function getValidationError() {
        agent.TestErrors.getValidationError()
            .then(() => console.log('should not see this')) // we should never see this console.log
    ...
    return(
        <Container>
            ...
            <ButtonGroup fullWidth>{/*Using the about page to test errors by creating buttons for them*/}
                {/*Catching error by the interceptor (what axios couldn't catch)*/}
